...
public class SampleData {
    public static void main(String[] args) throws Exception {
        Banner_UpdateAll_Api.execute(JSON.parseObject("{ \"apiName\": \"Banner_UpdateAll_Api\", \"banners\": [ { \"reorder\": \"1\", \"url\": \"url1\" }, { \"reorder\": \"2\", \"url\": \"url2\" }, { \"reorder\": \"3\", \"url\": \"url3\" }, { \"reorder\": \"4\", \"url\": \"url4\" }, { \"reorder\": \"5\", \"url\": \"url5\" } ] }", Banner_UpdateAll_Api.Req.class));
