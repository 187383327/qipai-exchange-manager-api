...
public class ImageText_QueryDetail_Api {
    ...
    public static Response execute(Request request) throws Exception {
        ...
        try (Connection conn = IgniteUtils.getConnection(Consts.jdbc_url)) {
            ...
            ResultSet selectRs = conn.createStatement().executeQuery(new SelectSql(ImageText.class).where(finalCondition).build());
            resp.setData(IgniteUtils.getJavaObject(selectRs, ImageText.class));
        }
        return resp;
    }
