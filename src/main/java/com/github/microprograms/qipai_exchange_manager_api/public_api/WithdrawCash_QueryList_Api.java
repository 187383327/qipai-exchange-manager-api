...
public class WithdrawCash_QueryList_Api {
    ...
    public static Response execute(Request request) throws Exception {
        ...
        try (Connection conn = IgniteUtils.getConnection(Consts.jdbc_url)) {
            ...
            ResultSet selectRs = conn.createStatement().executeQuery(new SelectSql(WithdrawCash.class).where(finalCondition).pager(pagerRequest).sorts(Sort.desc("dtCreate")).build());
    ...
    public static class Resp extends Response {
        ...
        public void setData(java.util.List<WithdrawCash> data) {
            this.data = data;
        }
